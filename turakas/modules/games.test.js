...
console.log(`--- END LOG ---
  ...
  ${typeof addedGame.id === 'string'}: game has an id (string)
  ${typeof addedGame.ip === 'string'}: game has an ip (string)
  ${typeof addedGame.name === 'string'}: game has an name (string)
  ${Array.isArray(addedGame.sockets)}: game has an sockets property (array)
  ${addedGame.sockets.length > 0}: game's sockets store is not empty
`)
